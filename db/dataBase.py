...
documentosPn={
    1: DocsPn(**{"id_docPN":1,
                "name_doc":"SOAT",
                "frenov":date(2021,1,22),
                "fvenc":date(2021,1,23),
                "falarm":date(2021,1,22),
                "email":"pepita@gmail.com"}),
    2: DocsPn(**{"id_docPN":2,
                "name_doc":"Licencia de conducir",
                "frenov":date(2022,11,30),
                "fvenc":date(2022,11,30),
                "falarm":date(2022,11,15),
                "email":"pepita@gmail.com"}),
    3: DocsPn(**{"id_docPN":3,
                "name_doc":"poliza de medicina prepagada",
                "frenov":date(2020,12,20),
                "fvenc":date(2020,12,20),
                "falarm":date(2020,12,12),
                "email":"pepita@gmail.com"}),
    4: DocsPn(**{"id_docPN":4,
                "name_doc":"SOAT",
                "frenov":date(2021,3,12),
                "fvenc":date(2021,3,12),
                "falarm":date(2021,3,12),
                "email":"juanito@gmail.com"}),
    5: DocsPn(**{"id_docPN":5,
                "name_doc":"ASODOCS",
                "frenov":date(2020,4,30),
                "fvenc":date(2020,5,7),
                "falarm":date(2020,4,25),
                "email":"juanito@gmail.com"}),
    6: DocsPn(**{"id_docPN":6,
                "name_doc":"Visa USA",
                "frenov":date(2020,4,30),
                ...
                "email":"juanito@gmail.com"}),  
    7: DocsPn(**{"id_docPN":7,
                "name_doc":"Membresía Club Lagartos",
                "frenov":date(2020,4,30),
                "fvenc":date(2020,5,7),
                "falarm":date(2020,4,25),
                "email":"juanito@gmail.com"}),  
    8: DocsPn(**{"id_docPN":8,
                "name_doc":"Póliza todo riesgo carro",
                "frenov":date(2020,4,30),
                "fvenc":date(2020,5,7),
                "falarm":date(2020,4,25),
                "email":"jdvpl@gmail.com"}),  
    9: DocsPn(**{"id_docPN":9,
                "name_doc":"Licencia de conducir moto",
                "frenov":date(2020,4,30),
                "fvenc":date(2020,5,7),
                "falarm":date(2020,4,25),
                "email":"jdvpl@gmail.com"}),  
    10: DocsPn(**{"id_docPN":10,
                "name_doc":"Membresía anual del gimnasio",
                "frenov":date(2020,4,30),
                "fvenc":date(2020,5,7),
                "falarm":date(2020,4,25),
                "email":"pepita@gmail.com"}),  
    11: DocsPn(**{"id_docPN":11,
                "name_doc":"Certificado de inglés",
                "frenov":date(2020,4,30),
                "fvenc":date(2020,5,7),
                "falarm":date(2020,4,25),
                "email":"jdvpl@gmail.com"}),  
    12: DocsPn(**{"id_docPN":12,
                "name_doc":"Pago anual ZUANA",
                "frenov":date(2020,4,30),
                "fvenc":date(2020,5,7),
                "falarm":date(2020,4,25),
                "email":"jdvpl@gmail.com"})  
